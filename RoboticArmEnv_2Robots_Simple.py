...
class RoboticArmEnv_V1(gym.Env):
    def __init__(self, training=True, num_arms=2, num_robots=2, arm_length=10, arm_width=0.5, destSize=5, alpha_reward=0.5):
        ...
        self.destSizes = np.array(np.arange(self.destSize - self.incremental_destSize + self.incremental_destSize * self.num_increments_dest,
                                  self.destSize - self.incremental_destSize, -self.incremental_destSize), dtype=float)
    ...
    def step(self, action):
        ...
        cube_centers, end_effectors = self.getArmPosition()

        # Collision detection between arms
        collision_detected = self.checkArmCollision(cube_centers)
    ...
    def getArmPosition(self):
        ...
        return cube_centers, end_effectors

    def checkArmCollision(self, cube_centers):
